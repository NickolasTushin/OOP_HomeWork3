...
public class Sample02 {
    ...
    /**
     * TODO: 2. generateEmployee должен создавать различных сотрудников (Worker,
     * Freelancer)
     * 
     * @return
     */
    static Employee generateEmployee() {
        String[] names = new String[] { "Анатолий", "Глеб", "Клим", "Евлампий", "Лазарь", "Полуэкт", "Клим", "Панкратий",
                "Рубен", "Герман" };
        String[] surnames = new String[] { "Вороватый", "Фукин", "Шестаков", "Хохлов", "Дубин", "Трусов", "Копылов",
                "Горбанько", "Залыткин", "Соколов" };
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Выбирете тип сортировки :\n1 - по имени\n2 - по ЗП\n3 - по возрасту\n");
...
class Worker extends Employee {
    ...
    public String toString() {
        return String.format(
                "%s %s; Рабочий; возраст: %d; Заработная плата (фиксированная месячная оплата): %.2f (руб.)", name,
                surName, age, salary);
    }
}
...
class Freelancer extends Employee {
    ...
    @Override
    public String toString() {
        return String.format("%s %s; Фрилансер; возраст: %d; Заработная плата (почасовая оплата): %.2f (руб.)", name,
                surName, age, salaryOfMontch);
    }
}